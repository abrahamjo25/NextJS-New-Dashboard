...
import MSOfficeLogo from '@/app/_components/assets/logos/msoffice.svg'
import ZoomLogo from '@/app/_components/assets/logos/zoom.svg'
import SlackLogo from '@/app/_components/assets/logos/slack.svg'
import GithubLogo from '@/app/_components/assets/logos/github.svg'
        ...
        <div className='text-sm grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
            ...
            <div className='border rounded-xl flex flex-col justify-between p-2.5 space-y-2'>
                ...
                <button className='flex text-xs group text-gray-500 font-medium rounded-lg w-full items-center justify-center gap-1 border px-2 py-1'>
                    <Settings2 size={16} className='group-hover:rotate-90 duration-300' />
                    <span>Manage</span>
                </button>
            </div>
            ...
            <div className='border rounded-xl flex flex-col justify-between p-2.5 space-y-2'>
                ...
                <button className='flex text-xs group text-gray-500 font-medium rounded-lg w-full items-center justify-center gap-1 border px-2 py-1'>
                    <Settings2 size={15} className='group-hover:rotate-90 duration-300' />
                    <span>Manage</span>
                </button>
